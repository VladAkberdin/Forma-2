...
namespace Forma_2.Database1DataSetTableAdapters {
...
SELECT Id, Фамилия, Имя, Отчество, [Дата рождения], Адрес FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Forma_2.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, Фамилия, Имя, Отчество, [Дата рождения], Адрес FROM dbo.[Table]";
